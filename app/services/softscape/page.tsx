...
export default function SoftscapePage() {
 ...
 <Image
 src="/softscape/center.png"
 alt="Fresh sod, mulched garden beds, and layered planting transforming a West GTA yard by McCoy Landscape Group"
 fill
 ...
 Fresh sod, mulched beds, and layered planting turning a bare yard
 into a finished landscape.
 </p>
 </div>
 </div>
 </div>
 ...
 <Image
 src={stepPhotos[i]}
 alt={`${step.title} — McCoy Landscape Group softscape process`}
 fill
 className="object-cover"
 ...
 <FinalCTA
 bgImage="/softscape/end.png"
 bgAlt="A finished softscape and lawn glowing at twilight in Oakville by McCoy Landscape Group"
 />
 <Footer />
 </>
 );
